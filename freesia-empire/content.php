...
$freesiaempire_settings = freesiaempire_get_theme_options();
	...
	<?php
		...
		<?php 
			...
			<span class="author vcard"><?php esc_html_e('Author :','freesia-empire')?><a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )); ?>" title="<?php the_title_attribute(); ?>">
